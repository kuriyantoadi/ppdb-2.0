...
<div class="container">
  ...
  $data_akl_h1 = mysqli_query($koneksi, "SELECT * FROM f_siswa_akl where tgl_pendaftaran='14-06-2021' and jenis_kelamin='Laki-laki' ");
  $jml_akl_h1_l = mysqli_num_rows($data_akl_h1);

  //akl hari ke-1 perempuan
  $data_akl_h1 = mysqli_query($koneksi, "SELECT * FROM f_siswa_akl where tgl_pendaftaran='14-06-2021' and jenis_kelamin='Perempuan' ");
  $jml_akl_h1_p = mysqli_num_rows($data_akl_h1);

  //akl hari ke-2 laki-laki
  $data_akl_h2 = mysqli_query($koneksi, "SELECT * FROM f_siswa_akl where tgl_pendaftaran='15-06-2021' and jenis_kelamin='Laki-laki' ");
  $jml_akl_h2_l = mysqli_num_rows($data_akl_h2);

  //akl hari ke-2 perempuan
  $data_akl_h2 = mysqli_query($koneksi, "SELECT * FROM f_siswa_akl where tgl_pendaftaran='15-06-2021' and jenis_kelamin='Perempuan' ");
  $jml_akl_h2_p = mysqli_num_rows($data_akl_h2);
