<?php
  ...
  function jml_diterima($nama_jur){
    include '../../koneksi.php';
  ...
  function jml_blm_upload($nama_jur){
    include '../../koneksi.php';
  ...
  function jml_sdh_upload($nama_jur){
    include '../../koneksi.php';
    $data = mysqli_query($koneksi, "SELECT *  from f_pengumuman where kondisi='DITERIMA' ");
    $rekap_diterima = mysqli_num_rows($data);
  ...
  function jml_datasesuai($nama_jur){
    include '../../koneksi.php';
  ...
  function jml_daftarulang($nama_jur){
    include '../../koneksi.php';
    $data = mysqli_query($koneksi, "SELECT *  from f_pengumuman where
