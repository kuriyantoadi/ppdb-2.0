...
<div class="container">
  ...
  <div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8">
      <center style="margin-top: 30px"><h3>Peserta Didik SMK Negeri 1 Kragilan</h3></center>
      <center style="margin-bottom: 30px"><h3>Kompetensi Keahlian <?= $nama_jurusan ?></h3></center>
		</div>
		<div class="col-md-2">
		</div>
  </div>
